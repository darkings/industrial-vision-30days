...
OUTPUT_JSON_PATH = Path(
  r"D:\Projects\industrial-vision-30days\week03-yolo\day17\outputs\batch_opencv_report\failed_cases.json"
)
OUTPUT_CSV_PATH = Path(
  r"D:\Projects\industrial-vision-30days\week03-yolo\day17\outputs\batch_opencv_report\failed_cases.csv"
)
...
def main():
  sumary_json_data = load_summary_json(SUMMARY_JSON_PATH)
  detections = filter_failed_summary(sumary_json_data)
