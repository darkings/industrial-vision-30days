...
2. `LEARNING_PLAN.md`：当前 30 天路线和阶段节奏。
3. Obsidian 中当天的理论笔记。
...
README 不维护“当前下一课”。需要继续学习时，优先查看 Obsidian 当天笔记和 `LEARNING_PLAN.md`。
...
6. 再按 AGENTS.md、LEARNING_PLAN.md 和 Obsidian 当天笔记继续。
```
...
环境或路径规则变化
项目级协作规则变化
用户明确要求更新 README / LEARNING_PLAN / _LearningErrors
```
