...
def create_run_context(config: RuntimeConfig) -> RunContext:
    ...
    outputs_dir = resolve_project_path(config.main_config.output.outputs_dir / run_id)
    reports_dir = resolve_project_path(config.main_config.output.reports_dir / run_id)
